...
const {login, registration, otpLogin, otpVerify,getInterviewers, updateUserData, getUserData, addConnection, changePassword} = require('../controller/userController');
...
route.get('/getInterviewers', getInterviewers)
